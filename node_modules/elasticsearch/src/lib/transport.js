...
AWS.config.credentials.accessKeyId = ACCESS_KEY_ID;
AWS.config.credentials.secretAccessKey = SECRET_ACCESS_KEY;
AWS.config.update({region:REGION});
AWS.config.apiVersions = {es:'2012-10-17'};
...
Transport.prototype.request = function (params, cb) {
  ...
  function sendReqWithConnection(err, _connection) {
    ...
    if (err) {
      ...
      httpRequest.method = params.req.method;
      httpRequest.path = params.req.path + (Object.keys(params.req.query).length > 0 ? "?" +  serializeQuery(params.req.query) : "");
      console.log(httpRequest.path);
      httpRequest.query = params.req.query;
      httpRequest.body = params.req.body;
      httpRequest.headers = params.req.headers;
      httpRequest.headers['Host'] = URL;
      httpRequest.headers['Content-type'] = 'application/json';
      var v4signer = new AWS.Signers.V4(httpRequest,'es');
